  ...
  return (
    ...
    <div className={isActive ? 'rounded-3xl flex flex-col items-center justify-center bg-[#303030] drop-shadow-2xl p-2' : 'rounded-3xl flex flex-col items-center justify-center bg-[#fff] drop-shadow-2xl p-2'}>
        ...
        <div className='p-4'>
         ...
         className={isActive ? 'transition-all delay-75 ease-in-out bg-[#3C9379] px-24 py-2 rounded-3xl hover:text-[black] hover:bg-[#fff] border-2 border-[#3c9379]' 
        : 'transition-all delay-75 ease-in-out bg-[#3C9379] px-24 py-2 rounded-3xl hover:bg-[#fff] border-2 border-[#3c9379]'} >Add To Cart</button>
        </div>
    </div>
